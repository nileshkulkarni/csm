...
class CSPTester(test_utils.Tester):
    ...
    def evaluate(self, ):
        ...
        transfer_kps12, error_kps12 = self.map_kp_img1_to_img2(common_kp_indices, kps3d[0], kp_inds[1], mask[1],  camera[1],)
        transfer_kps21, error_kps21 = self.map_kp_img1_to_img2(common_kp_indices, kps3d[1], kp_inds[0],  mask[0], camera[0])
